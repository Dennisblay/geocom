...
const Features = () => {
    return (
        <div className="px-8 bg-background grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
            <div
                className="relative p-9 hover:bg-secondary   border-[0.1rem] border-primary flex flex-col justify-center items-center  rounded-xl bg-border">
                <img src={g1} className='w-24' alt=""/>
                <div className='absolute inset-0 flex items-center justify-center'>
                    <img src={level} className='w-10' alt=""/>
                </div>
                <div>
